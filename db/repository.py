...
if __name__ == "__main__":
    ...
    # Create project
    project = Project(name="Build Website", description="Company website")
    ...
    # Create task
    task = Task(title="Build Login", project_id=project.id, priority="high")
    ...
    print(f"Tasks for project {project.id}: {len(tasks)}")
    for t in tasks:
        print(f"  → {t}")